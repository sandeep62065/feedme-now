          ...
          <div className="flex flex-col gap-4">
            ...
            <nav className="flex flex-col gap-2 text-sm">
              {[
                ...
                <a key={l.label} href={l.to} className="text-gray-500 hover:text-amber-400 transition-colors">
                  {l.label}
                </a>
              ))}
            </nav>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-3">
              {[
                ...
                { label: 'Twitter / X', href: '#', icon: <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg> },
              ].map((s) => (
                <a key={s.label} href={s.href} aria-label={s.label} className="w-10 h-10 rounded-xl bg-white/5 hover:bg-amber-500 text-gray-400 hover:text-white flex items-center justify-center transition-all">
                  {s.icon}
                </a>
              ))}
            </div>
          ...
          <CartProvider>
            ...
            <Routes>
              ...
              <Route element={<MainLayout />}>
                ...
                <Route path="/orders/:id" element={<ProtectedRoute><OrderHistoryPage /></ProtectedRoute>} />
